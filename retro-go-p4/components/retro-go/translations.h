...
static const char *translations[][RG_LANG_MAX] =
{
    ...
    {
        [RG_LANG_EN] = "Touch buttons",
        [RG_LANG_FR] = "Boutons tactiles",
        [RG_LANG_ZH] = "虚拟按键",
    },
    {
        [RG_LANG_EN] = "Touch opacity",
        [RG_LANG_FR] = "Opacite tactile",
        [RG_LANG_ZH] = "按键透明度",
    },
    {
        [RG_LANG_EN] = "Timezone",
